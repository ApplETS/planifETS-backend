...
export class EmbeddingController {
  ...
  @ApiOperation({
    summary:
      'Return all rows from v_courses_for_embedding (one per course-program pair)'
  })
  ...
  @Get('count')
  @ApiOperation({
    summary: 'Get the total number of distinct courses in the embedding view'
  })
  ...
  @ApiOperation({
    summary:
      'Return all rows for a given course (one per program it belongs to)'
  })
